...
![architecture](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/blob/main/user_guides/routes-externaldns-waf/diagram/2022-12-06_15-50-57.png)
...
CIS [repo](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/tree/main/user_guides/routes-externaldns-waf/cis)
...
```
Routes [repo](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/tree/main/user_guides/routes-externaldns-waf/ocp-route/cafeone/route)
...
oc create -f route-mocha-edge.yaml
```
Routes [repo](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/tree/main/user_guides/routes-externaldns-waf/ocp-route/cafetwo)

Validate OpenShift Routes for cafeone

![openshift](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/blob/main/user_guides/routes-externaldns-waf/diagram/2022-12-06_16-49-29.png)

Validate OpenShift Virtual IPs for **cafeone** and **cafetwo** using the BIG-IP

![big-ip](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/blob/main/user_guides/routes-externaldns-waf/diagram/2022-12-06_16-50-18.png)
...
AS3 [repo](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/blob/main/user_guides/routes-externaldns-waf/bigip-gslb-common/bigip-gslb-common.json)
...
ExternalDNS [repo](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/blob/main/user_guides/routes-externaldns-waf/ocp-route/cafeone/crd/edns-cafeone.yaml)
...
ExternalDNS [repo](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/blob/main/user_guides/routes-externaldns-waf/ocp-route/cafetwo/crd/edns-cafetwo.yaml)

Validate Wide-IPs on the BIG-IP

![WIDE-IP](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/blob/main/user_guides/routes-externaldns-waf/diagram/2022-12-06_17-03-01.png)
...
PolicyCRD [repo](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/blob/main/user_guides/routes-externaldns-waf/ocp-route/cafeone/crd/policy-cafe.yaml)

Validate WAF Policy on the BIG-IP

![WAF](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/blob/main/user_guides/routes-externaldns-waf/diagram/2022-12-06_17-39-38.png)
...
![WAF](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/blob/main/user_guides/routes-externaldns-waf/diagram/2022-12-06_17-45-12.png)

Validate Request Logging on BIG-IP 

![Block](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/blob/main/user_guides/routes-externaldns-waf/diagram/2022-12-06_17-50-16.png)