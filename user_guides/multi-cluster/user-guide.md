...
![diagram](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/blob/main/user_guides/multi-cluster/diagrams/2021-05-10_12-07-00.png)
...
![vxlan-tunnel](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/blob/main/user_guides/multi-cluster/diagrams/2021-05-10_12-11-17.png)

Self-IPs configuration for vxlan-tunnel-dev

![self-ip](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/blob/main/user_guides/multi-cluster/diagrams/2021-05-10_12-28-33.png)
...
![vxlan-tunnel](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/blob/main/user_guides/multi-cluster/diagrams/2021-05-10_12-11-53.png)

Self-IPs configuration for vxlan-tunnel-prod

![self-ip](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/blob/main/user_guides/multi-cluster/diagrams/2021-05-10_12-27-39.png)
...
dev-cluster
* f5-bigip-dev-node.yaml [repo](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/blob/main/user_guides/multi-cluster/dev-cluster/cis/cis-deployment/f5-bigip-dev-node.yaml)

prod-cluster
* f5-bigip-prod-node.yaml [repo](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/blob/main/user_guides/multi-cluster/prod-cluster/cis/cis-deployment/f5-bigip-prod-node.yaml)
...
dev-cluster
* f5-cis-deployment.yaml [repo](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/blob/main/user_guides/multi-cluster/dev-cluster/cis/cis-deployment/f5-cis-deployment.yaml)

prod-cluster
* f5-cis-deployment.yaml [repo](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/blob/main/user_guides/multi-cluster/prod-cluster/cis/cis-deployment/f5-cis-deployment.yaml)
...
dev-cluster
* f5-ipam-deployment [repo](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/blob/main/user_guides/multi-cluster/dev-cluster/ipam/f5-ipam-deployment.yaml)

prod-cluster
* f5-cis-deployment.yaml [repo](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/blob/main/user_guides/multi-cluster/prod-cluster/ipam/f5-ipam-deployment.yaml)
...
crd-resource [repo](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/tree/main/user_guides/multi-cluster/dev-cluster/cis/crd-resource)
...
crd-resource [repo](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/tree/main/user_guides/multi-cluster/prod-cluster/cis/crd-resource)

**Note** For more information on F5 CIS and IPAM please review my user-guide and demo at [repo](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/blob/main/user_guides/ipam/README.md)
