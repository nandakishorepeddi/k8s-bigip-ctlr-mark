...
![architecture](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/blob/main/user_guides/k8s-ha/diagrams/2021-05-19_11-19-07.png)
...
* f5-bigip-node-91.yaml [repo](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/blob/main/user_guides/k8s-ha/big-ip-91/f5-bigip-node-91.yaml)
* f5-bigip-node-92.yaml [repo](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/blob/main/user_guides/k8s-ha/big-ip-92/f5-bigip-node-92.yaml)
...
![bigip1](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/blob/main/user_guides/k8s-ha/diagrams/2021-04-13_10-08-15.png)

bigip2

![bigip2](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/blob/main/user_guides/k8s-ha/diagrams/2021-04-13_10-10-04.png)
...
bigip1
* f5-bigip-ctlr-deployment-91.yaml [repo](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/blob/main/user_guides/k8s-ha/big-ip-91/f5-bigip-ctlr-deployment-91.yaml)

bigip2
* f5-bigip-ctlr-deployment-92.yaml [repo](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/blob/main/user_guides/k8s-ha/big-ip-92/f5-bigip-ctlr-deployment-92.yaml)
...
This solution works but you cannot have ANY floating IP addresses. If the K8S nodes are pointing to the BIG-IP internal floating self-ip you would need to remove the self-ip and configure a default gateway forwarding VIP as shown in the diagram below. This is created in Common
 ...
 ![defaultgatewa](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/blob/main/user_guides/k8s-ha/diagrams/2021-04-13_13-17-33.png)