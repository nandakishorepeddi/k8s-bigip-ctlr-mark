...
![architecture](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/blob/main/user_guides/per-application-failover/diagram/2022-01-31_14-03-56.png)
...
cis-deployment [repo](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/tree/main/user_guides/per-application-failover/cis/cis-deployment)
...
nginx-config [repo](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/tree/main/user_guides/per-application-failover/nginx-config)
...
ingress-example [repo](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/tree/main/user_guides/per-application-failover/ingress-example)
...
![combo](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/blob/main/user_guides/per-application-failover/diagram/2022-02-01_12-31-07.png)
...
TLSProfile [repo](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/tree/main/user_guides/per-application-failover/cis/cafe/reencrypt)
...
VirtualServer [repo](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/tree/main/user_guides/per-application-failover/cis/cafe/virtualserver)
...
![BIG-IP LTM](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/blob/main/user_guides/per-application-failover/diagram/2022-02-01_11-42-23.png)
...
ExternalDNS [repo](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/tree/main/user_guides/per-application-failover/cis/cafe/externaldns) 
...
![Wide IP](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/blob/main/user_guides/per-application-failover/diagram/2022-01-31_15-55-49.png)

Validated DNS monitor for application **tea.example.com**

![Wide IP](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/blob/main/user_guides/per-application-failover/diagram/2022-02-01_12-50-26.png)
...
![DNS](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/blob/main/user_guides/per-application-failover/diagram/2022-02-01_12-55-20.png)

Connect to the Public IP via the FQDN and application Path. Example below of /tea, /coffee and /mocha

![traffic](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/blob/main/user_guides/per-application-failover/diagram/2022-02-01_13-02-20.png)
...
```
![failure](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/blob/main/user_guides/per-application-failover/diagram/2022-02-01_13-13-04.png)

Demonstrate the failed monitor

![monitor](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/blob/main/user_guides/per-application-failover/diagram/2022-02-01_13-17-24.png)