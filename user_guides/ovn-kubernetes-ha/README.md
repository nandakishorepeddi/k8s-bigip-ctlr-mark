...
![architecture](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/blob/main/user_guides/ovn-kubernetes-ha/diagram/2022-10-18_14-57-50.png)
...
metadata:
  ...
  name: cafe
```
routing-external-gws [repo](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/blob/main/user_guides/ovn-kubernetes-ha/demo-app/cafe/name-cafe.yaml)
...
CIS [repo](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/tree/main/user_guides/ovn-kubernetes-ha/next-gen-route/cis)
...
```
ConfigMap [repo](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/blob/main/user_guides/ovn-kubernetes-ha/next-gen-route/route/global-cm.yaml)
...
Routes [repo](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/tree/main/user_guides/ovn-kubernetes-ha/next-gen-route/route/cafe/secure)

Validate OpenShift Routes using the BIG-IP

![big-ip route](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/blob/main/user_guides/ovn-kubernetes-ha/diagram/2022-06-07_15-35-21.png)

Validate OpenShift Virtual IP using the BIG-IP

![big-ip pools](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/blob/main/user_guides/ovn-kubernetes-ha/diagram/2022-06-07_15-37-33.png)

Validate OpenShift Routes policies on the BIG-IP

![traffic](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/blob/main/user_guides/ovn-kubernetes-ha/diagram/2022-06-07_15-38-08.png)

Validate OpenShift Routes policies by connecting to the Public IP

![traffic](https://github.com/nandakishorepeddi/k8s-bigip-ctlr-mark/blob/main/user_guides/ovn-kubernetes-ha/diagram/2022-10-12_13-46-30.png)